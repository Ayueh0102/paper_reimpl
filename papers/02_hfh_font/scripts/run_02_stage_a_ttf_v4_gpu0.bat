...
chcp 65001 >nul
setlocal
REM 02 Stage A v4 — 100k U-Net continuation warm-start from v3 ckpt (cuda:0).
REM Variant of v4_gpu1.bat for parallel run while cuda:1 chain (05/08) is busy.
...
set LOG=D:\Char\ayueh\paper_reimpl\logs\02_stage_a_ttf_v4_gpu0_%DT%.log
