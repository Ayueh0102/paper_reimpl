...
chcp 65001 >nul
setlocal
REM 08 Stage B PINN OFF 50k on cuda:1 (warm-start from Stage A v3 ckpt).
...
set TRAIN=%PAPER_DIR%\src\dp_font\configs\train_stage_b_long_pinn0.yaml
...
set LOG=D:\Char\ayueh\paper_reimpl\logs\08_stage_b_long_pinn0_gpu1_%DT%.log
